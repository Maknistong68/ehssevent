...
| P7 | Consent & DSR records | Consent stamps, request records | No | **Legal obligation** (accountability) | — | This is how you *prove* the bases for P1–P9. |
...
- **Where consent is the right basis:** only **P8** (and the *acceptance* action in P1).
...
- **Red flag:** anything that previously relied on consent for **P2 / P3** must move to
  **legal obligation**. In an employer-to-worker context, consent is not "freely given,"
  and an injured worker cannot refuse to be recorded — so consent is the *wrong* and
  weaker basis.
