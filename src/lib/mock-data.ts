...
export const MOCK_ORGANIZATIONS: Organization[] = [
  {
    id: CLIENT_ORG_ID,
    name: 'NEOM Port Authority',
    org_type: 'client',
    logo_url: null,
    contact_email: 'admin@neomport.sa',
    is_active: true,
  ...
  },
  {
    ...
    org_type: 'contractor',
    logo_url: null,
    contact_email: 'info@alrashid.sa',
    is_active: true,
  ...
  },
  {
    ...
    name: 'Gulf Engineering Services',
    org_type: 'contractor',
    logo_url: null,
    contact_email: 'contact@gulfeng.sa',
    is_active: true,
  ...
  },
  {
    ...
    org_type: 'contractor',
    logo_url: null,
    contact_email: 'ops@saudisteel.sa',
    is_active: true,
...
export const MOCK_PROFILES: Profile[] = [
  ...
  {
    id: USER2_ID,
    email: 'sarah.manager@neomport.sa',
  ...
  },
  {
    ...
    email: 'khalid@gulfeng.sa',
    full_name: 'Khalid Gulf',
    role: 'contractor_user',
  ...
  },
  {
    ...
    email: 'omar@saudisteel.sa',
    full_name: 'Omar Steel',
    role: 'contractor_user',
...
export const MOCK_PROJECTS: Project[] = [
  ...
  {
    id: PROJECT3_ID,
    name: 'Marine Infrastructure Works',
...
export const MOCK_EVENTS: Event[] = [
  {
    ...
    contractor: 'Al-Rashid Construction',
  ...
  },
  {
    ...
    contractor: 'Gulf Engineering Services',
    ...
    creator: { id: USER2_ID, email: 'sarah.manager@neomport.sa', full_name: 'Sarah Manager', role: 'client_manager', organization_id: CLIENT_ORG_ID, is_active: true, terms_accepted_at: null, privacy_accepted_at: null, terms_version: null, privacy_version: null, created_at: '2025-01-02T00:00:00Z', updated_at: '2025-01-02T00:00:00Z' },
    creator_organization: CLIENT_ORG_OBJ,
  },
  {
    id: EVENT3_ID,
    ...
    project: MOCK_PROJECTS[0],
    creator: { id: CONTRACTOR_USER1_ID, email: 'ahmed@alrashid.sa', full_name: 'Ahmed Al-Rashid', role: 'contractor_user', organization_id: CONTRACTOR_ORG1_ID, is_active: true, terms_accepted_at: null, privacy_accepted_at: null, terms_version: null, privacy_version: null, created_at: '2025-01-06T00:00:00Z', updated_at: '2025-01-06T00:00:00Z' },
  ...
  },
  {
    ...
    work_related: true,
    impacted_party: null,
    leadership_member_name: 'VP Operations',
    attendees: 'Site supervisor, HSE team, VP Operations',
    ...
    project: MOCK_PROJECTS[0],
    creator: { id: USER3_ID, email: 'mike.user@neomport.sa', full_name: 'Mike User', role: 'client_user', organization_id: CLIENT_ORG_ID, is_active: true, terms_accepted_at: null, privacy_accepted_at: null, terms_version: null, privacy_version: null, created_at: '2025-01-03T00:00:00Z', updated_at: '2025-01-03T00:00:00Z' },
    creator_organization: CLIENT_ORG_OBJ,
  },
]
...
export const MOCK_EVENT_RESPONSES: EventResponse[] = [
  {
    ...
    responder: { id: USER2_ID, email: 'sarah.manager@neomport.sa', full_name: 'Sarah Manager', role: 'client_manager', organization_id: CLIENT_ORG_ID, is_active: true, terms_accepted_at: null, privacy_accepted_at: null, terms_version: null, privacy_version: null, created_at: '2025-01-02T00:00:00Z', updated_at: '2025-01-02T00:00:00Z' },
  ...
  },
  {
    ...
    responder: { id: CONTRACTOR_USER1_ID, email: 'ahmed@alrashid.sa', full_name: 'Ahmed Al-Rashid', role: 'contractor_user', organization_id: CONTRACTOR_ORG1_ID, is_active: true, terms_accepted_at: null, privacy_accepted_at: null, terms_version: null, privacy_version: null, created_at: '2025-01-06T00:00:00Z', updated_at: '2025-01-06T00:00:00Z' },
...
export const MOCK_CORRECTIVE_ACTIONS: CorrectiveAction[] = [
  {
    ...
    created_by: MOCK_USER_ID,
    creator_org_id: CLIENT_ORG_ID,
    assigned_to: CONTRACTOR_USER1_ID,
...
export const MOCK_INSPECTIONS: Inspection[] = [
  ...
  },
  {
    ...
    template: { id: TEMPLATE1_ID, name: 'General Site Safety Inspection' } as InspectionTemplate,
    project: MOCK_PROJECTS[1],
    conductor: { id: USER2_ID, email: 'sarah.manager@neomport.sa', full_name: 'Sarah Manager', role: 'client_manager', organization_id: CLIENT_ORG_ID, is_active: true, terms_accepted_at: null, privacy_accepted_at: null, terms_version: null, privacy_version: null, created_at: '2025-01-02T00:00:00Z', updated_at: '2025-01-02T00:00:00Z' },
  },
]
...
export const MOCK_AUDIT_LOGS: AuditLogEntry[] = [
  {
    ...
    target_label: 'ahmed@alrashid.sa',
  ...
  },
  {
    ...
    target_label: 'Saudi Steel Works',
